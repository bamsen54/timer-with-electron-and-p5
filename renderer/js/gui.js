...
function display_count_down(seconds_left) {
    ...
    if( program_status == 'count down'  ) {
        ...
        DOM.count_down_span.textContent = text_display;
    }
    
    else if( program_status == 'expired' ) {

        DOM.count_down_span.textContent = 'Alarm Expired!';
    }

    else
        DOM.count_down_span.textContent = '';
...
function display_when_alarm_will_go_off(date) {
    ...
    DOM.count_down_finished_at_span.style.display = '';


    DOM.count_down_finished_at_span.textContent = date_string;
}
